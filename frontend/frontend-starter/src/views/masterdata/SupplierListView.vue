...
const error = ref("");
const form = ref({ nama: "", phone: "", email: "", alamat: "" });
...
function openCreate() {
    editId.value = null;
    form.value = { nama: "", phone: "", email: "", alamat: "" };
    error.value = "";
    showForm.value = true;
}
...
async function doDelete() {
    deleting.value = true;
    try {
        await api.delete(`/suppliers/${deleteId.value}`);
